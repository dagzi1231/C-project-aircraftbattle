...
#define PLAYERFILE_PATH "D:\\cproject\\qt_AircraftBattle\\playerFile.dat"  //玩家数据文件
#define COMMONRECORDFILE_PATH "D:\\cproject\\qt_AircraftBattle\\commonrecord.dat"  //玩家数据文件
#define ENDLESSRECORDFILE_PATH "D:\\cproject\\qt_AircraftBattle\\endlessrecord.dat"  //玩家数据文件
