...
#define PLAYERFILE_PATH "D:\\cproject\\C-project-aircraftbattle\\playerFile.dat"  //玩家数据文件
#define COMMONRECORDFILE_PATH "D:\\cproject\\C-project-aircraftbattle\\commonrecord.dat"  //玩家数据文件
#define ENDLESSRECORDFILE_PATH "D:\\cproject\\C-project-aircraftbattle\\endlessrecord.dat"  //玩家数据文件
